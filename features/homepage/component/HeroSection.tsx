      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Decorative Elements */}
            <div className="absolute top-1/2 -right-8 w-16 h-16 bg-blue-500/10 rounded-full blur-xl"></div>
            <div className="absolute bottom-1/4 -left-8 w-20 h-20 bg-green-500/10 rounded-full blur-xl"></div>
          </div>
        </div>
