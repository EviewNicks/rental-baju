...
import type { Product, Category, ClientProduct, ClientCategory, BaseCategory } from '../../types'
  ...
  return {
    ...
    createdAt:
      clientProduct.createdAt instanceof Date
        ...
        : new Date(clientProduct.createdAt),
    updatedAt:
      clientProduct.updatedAt instanceof Date
        ? clientProduct.updatedAt
        : new Date(clientProduct.updatedAt),
...
export function categoryToClientCategory(category: Category): ClientCategory {
  return {
    ...category,
    createdAt:
      category.createdAt instanceof Date ? category.createdAt : new Date(category.createdAt),
    updatedAt:
      category.updatedAt instanceof Date ? category.updatedAt : new Date(category.updatedAt),
...
export function clientCategoryToCategory(clientCategory: ClientCategory): any {
  return {
    ...clientCategory,
    createdAt:
      clientCategory.createdAt instanceof Date
        ? clientCategory.createdAt
        : new Date(clientCategory.createdAt),
    updatedAt:
      clientCategory.updatedAt instanceof Date
        ? clientCategory.updatedAt
        : new Date(clientCategory.updatedAt),
