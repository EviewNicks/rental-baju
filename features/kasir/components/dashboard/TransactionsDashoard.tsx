...
export function TransactionsDashboard() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4" data-testid="kasir-main-content">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="text-center space-y-2" data-testid="kasir-header">
            <h1 className="text-2xl font-bold text-gray-900" data-testid="kasir-title">RentalBaju</h1>
            <p className="text-gray-600" data-testid="kasir-subtitle">Daftar Transaksi Penyewaan</p>
          </div>
          
          <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center" data-testid="error-boundary">
